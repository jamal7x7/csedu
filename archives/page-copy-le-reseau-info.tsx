...
import Def from '@/components/chapterBlocks/Def'
  ...
  return (
    ...
    <main className='min-h-screen container mx-auto   '>
      ...
      <div className='flex flex-col  max-w-3xl  mx-auto gap-12 pb-16'>
        ...
        {/* =============================Title================================  */}
        <ChapterTitle chapterNumber={params.chapterId}> Le Réseau Informatique </ChapterTitle>
        {/* =============================Title-End================================  */}
        ...
        {/* ================================================================ */}
        <div className=' flex flex-col items-center justify-between 2xl:px-24   p-4   rounded-3xl border border-muted/5 bg-muted/50 dark:bg-muted/20 text-card-foreground shadow-sm'>
          ...
          <Card className='pb-4 px-0 mx-4  rounded-t-lg '>
