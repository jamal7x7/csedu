...
CREATE TABLE IF NOT EXISTS "Grades_Tests" (
	...
	CONSTRAINT "Grades_Tests_gradeIdId_testIdId_pk" PRIMARY KEY("gradeIdId","testIdId")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Grades_Tests" ADD CONSTRAINT "Grades_Tests_testIdId_Test_id_fk" FOREIGN KEY ("testIdId") REFERENCES "Test"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
