        ...
        <Table className=" StickyHeader ">
          <TableHeader className="  ">
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow
                key={headerGroup.id}
                // className='border-b-[1px] border-muted-foreground/15 [&:has([role=checkbox])]:!pr-4  bg-background backdrop-blur supports-[backdrop-filter]:bg-background/90  drop-shadow-[0_2px_0px_rgba(0,0,0,0.15)] dark:drop-shadow-[0_2px_0px_rgba(200,200,200,0.15)] '
              >
              ...
              table.getRowModel().rows.map((row) => (
                ...
                >
                  {row.getVisibleCells().map((cell) => (
                    <TableCell
                      className="border-b-[1px] border-muted-foreground/15 [&:has([role=checkbox])]:!pr-4 "
                      key={cell.id}
                    >
                      {flexRender(
