...
CREATE TABLE IF NOT EXISTS "Profile" (
	...
	"bio" text,
	"birthDate" text DEFAULT 'dd-mm-yyyy' NOT NULL
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "Student_sClassId_key" ON "Student" ("sClassId");--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "Assessment" ADD CONSTRAINT "Assessment_sectionId_Section_id_fk" FOREIGN KEY ("sectionId") REFERENCES "Section"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Chapter" ADD CONSTRAINT "Chapter_unitId_Unit_id_fk" FOREIGN KEY ("unitId") REFERENCES "Unit"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "GradesToTests" ADD CONSTRAINT "GradesToTests_testId_Test_id_fk" FOREIGN KEY ("testId") REFERENCES "Test"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "SClass" ADD CONSTRAINT "SClass_schoolYearId_SchoolYear_id_fk" FOREIGN KEY ("schoolYearId") REFERENCES "SchoolYear"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Student" ADD CONSTRAINT "Student_sClassId_SClass_id_fk" FOREIGN KEY ("sClassId") REFERENCES "SClass"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Teacher" ADD CONSTRAINT "Teacher_subjectId_Subject_id_fk" FOREIGN KEY ("subjectId") REFERENCES "Subject"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Term" ADD CONSTRAINT "Term_schoolYearId_SchoolYear_id_fk" FOREIGN KEY ("schoolYearId") REFERENCES "SchoolYear"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
